...
<head>
	<?php
		...
		function getConcerts($username) {
			$concerts = getUserConcerts($username, "cdate");
			$returnString = '';
...
$(document).ready(function(){
    ...
    <p id="distance" class="resultSection">Upcoming</p>
   ...
   <div id="artist3block" class="block" style="display:none"> 
    ...
    <input type="submit" id="distanceButton" class="myButton" value="Distance" onClick="window.location.href='DistanceResults.php'" style="position:absolute; top:15%; left:85%; height:80px; width:150px"/>
